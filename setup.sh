...
# ============================================================================
RECIPE_FEDORA=(nvidia ssh stow zsh git gh btop clamav fnm claude docker fonts ghostty gitkraken just lazydocker lazygit nvim nvidia-container-toolkit opentofu timeshift uv vscode cursor aws)
